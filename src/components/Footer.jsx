    ...
    <footer className={`w-full mt-12 border-t ${
      ...
      <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <img src={logo} alt="FinTrack Logo" className="h-8 w-auto object-contain filter brightness-90 contrast-110" />
          <span className={darkMode ? "text-emerald-400 text-lg font-serif italic font-bold" : "text-emerald-700 text-lg font-serif italic font-bold"}>
            FinTrack
          </span>
        </div>
